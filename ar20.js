...
function AR1(){
	...
	document.getElementById("bt1").innerHTML="<a href='/?1d' class='botao_1'>Desliga</a>";
    } else {
        document.getElementById("et1").innerHTML="0";
        document.getElementById("rl1").innerHTML="<div class='rele1_desligado'></div>";
        document.getElementById("bt1").innerHTML="<a href='/?1l' class='botao_1'>Liga</a>";
    }
}
...
function AR2(){
	...
	document.getElementById("bt2").innerHTML="<a href='/?2d' class='botao_2'>Desliga</a>";
    } else {
        document.getElementById("et2").innerHTML="0";
        document.getElementById("rl2").innerHTML="<div class='rele2_desligado'></div>";
        document.getElementById("bt2").innerHTML="<a href='/?2l' class='botao_2'>Liga</a>";
    }
}
...
function AR3(){
	...
	document.getElementById("bt3").innerHTML="<a href='/?3d' class='botao_3'>Desliga</a>";
    } else {
        document.getElementById("et3").innerHTML="0";
        document.getElementById("rl3").innerHTML="<div class='rele3_desligado'></div>";
        document.getElementById("bt3").innerHTML="<a href='/?3l' class='botao_3'>Liga</a>";
    }
}
...
function AR4(){
	...
	document.getElementById("bt4").innerHTML="<a href='/?4d' class='botao_4'>Desliga</a>";
    } else {
        document.getElementById("et4").innerHTML="0";
        document.getElementById("rl4").innerHTML="<div class='rele4_desligado'></div>";
        document.getElementById("bt4").innerHTML="<a href='/?4l' class='botao_4'>Liga</a>";
    }
}
...
function AR5(){
	...
	document.getElementById("bt5").innerHTML="<a href='/?5d' class='botao_5'>Desliga</a>";
    } else {
        document.getElementById("et5").innerHTML="0";
        document.getElementById("rl5").innerHTML="<div class='rele5_desligado'></div>";
        document.getElementById("bt5").innerHTML="<a href='/?5l' class='botao_5'>Liga</a>";
    }
}
...
function AR6(){
	...
	document.getElementById("bt6").innerHTML="<a href='/?6d' class='botao_6'>Desliga</a>";
    } else {
        document.getElementById("et6").innerHTML="0";
        document.getElementById("rl6").innerHTML="<div class='rele6_desligado'></div>";
        document.getElementById("bt6").innerHTML="<a href='/?6l' class='botao_6'>Liga</a>";
    }
}
...
function AR7(){
	...
	document.getElementById("bt7").innerHTML="<a href='/?7d' class='botao_7'>Desliga</a>";
    } else {
        document.getElementById("et7").innerHTML="0";
        document.getElementById("rl7").innerHTML="<div class='rele7_desligado'></div>";
        document.getElementById("bt7").innerHTML="<a href='/?7l' class='botao_7'>Liga</a>";
    }
}
...
function AR8(){
	...
	document.getElementById("bt8").innerHTML="<a href='/?8d' class='botao_8'>Desliga</a>";
    } else {
        document.getElementById("et8").innerHTML="0";
        document.getElementById("rl8").innerHTML="<div class='rele8_desligado'></div>";
        document.getElementById("bt8").innerHTML="<a href='/?8l' class='botao_8'>Liga</a>";
    }
}
...
function AR9(){
	...
	document.getElementById("bt9").innerHTML="<a href='/?9d' class='botao_9'>Desliga</a>";
    } else {
        document.getElementById("et9").innerHTML="0";
        document.getElementById("rl9").innerHTML="<div class='rele9_desligado'></div>";
        document.getElementById("bt9").innerHTML="<a href='/?9l' class='botao_9'>Liga</a>";
    }
}
...
function AR10(){
	...
	document.getElementById("bt10").innerHTML="<a href='/?10d' class='botao_10'>Desliga</a>";
    } else {
        document.getElementById("et10").innerHTML="0";
        document.getElementById("rl10").innerHTML="<div class='rele10_desligado'></div>";
        document.getElementById("bt10").innerHTML="<a href='/?10l' class='botao_10'>Liga</a>";
    }
}
...
function AR11(){
	...
	document.getElementById("bt11").innerHTML="<a href='/?11d' class='botao_11'>Desliga</a>";
    } else {
        document.getElementById("et11").innerHTML="0";
        document.getElementById("rl11").innerHTML="<div class='rele11_desligado'></div>";
        document.getElementById("bt11").innerHTML="<a href='/?11l' class='botao_11'>Liga</a>";
    }
}
...
function AR12(){
	...
	document.getElementById("bt12").innerHTML="<a href='/?12d' class='botao_12'>Desliga</a>";
    } else {
        document.getElementById("et12").innerHTML="0";
        document.getElementById("rl12").innerHTML="<div class='rele12_desligado'></div>";
        document.getElementById("bt12").innerHTML="<a href='/?12l' class='botao_12'>Liga</a>";
    }
}
...
function AR13(){
	...
	document.getElementById("bt13").innerHTML="<a href='/?13d' class='botao_13'>Desliga</a>";
    } else {
        document.getElementById("et13").innerHTML="0";
        document.getElementById("rl13").innerHTML="<div class='rele13_desligado'></div>";
        document.getElementById("bt13").innerHTML="<a href='/?13l' class='botao_13'>Liga</a>";
    }
}
...
function AR14(){
	...
	document.getElementById("bt14").innerHTML="<a href='/?14d' class='botao_14'>Desliga</a>";
    } else {
        document.getElementById("et14").innerHTML="0";
        document.getElementById("rl14").innerHTML="<div class='rele14_desligado'></div>";
        document.getElementById("bt14").innerHTML="<a href='/?14l' class='botao_14'>Liga</a>";
    }
}
...
function AR15(){
	...
	document.getElementById("bt15").innerHTML="<a href='/?15d' class='botao_15'>ACIONAR</a>";
    } else {
        document.getElementById("et15").innerHTML="0";
        document.getElementById("rl15").innerHTML="<div class='rele15_desligado'></div>";
        document.getElementById("bt15").innerHTML="<a href='/?15l' class='botao_15'>ACIONAR</a>";
    }
}
...
function AR16(){
	...
	document.getElementById("bt16").innerHTML="<a href='/?16d' class='botao_16'>Desliga</a>";
    } else {
        document.getElementById("et16").innerHTML="0";
        document.getElementById("rl16").innerHTML="<div class='rele16_desligado'></div>";
        document.getElementById("bt16").innerHTML="<a href='/?16l' class='botao_16'>Liga</a>";
    }
}
